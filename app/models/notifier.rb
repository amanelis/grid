class Notifier < ActionMailer::Base
  ...
  def weekly_report(account, email_list = nil, date = nil)
    ...
    part :content_type => "text/html", :body => render_message(:account_report_data => account.previous_days_report_data(date, 6))
    part :content_type => "text/plain", :body => render_message(:account_report_data => account.previous_days_report_data(date, 6))
  end
