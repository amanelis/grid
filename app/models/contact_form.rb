class ContactForm < ActiveRecord::Base
  ...
  def get_form_text
      ...
      form_text += "<p align=\"center\"><label for=\"work_description\">Description of problem or concerns</label><input id=\"work_description\" type=\"textarea\" name=\"submission[work_description]\"/></br>" if self.work_description == true   
