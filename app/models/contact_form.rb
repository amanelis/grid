class ContactForm < ActiveRecord::Base
  ...
  def get_form_text()
      form_text = "<form action=\"http://grid.cityvoice.com/submission\" method=\"POST\" name=\"Form1\" onSubmit=\"return checkform()\">
                   <input type=hidden id=\"contact_form_id\" name=\"submission[contact_form_id]\" value=\"#{self.id}\"> 
                   <input type=hidden name=\"submission[retURL]\" value=\"#{self.return_url}\">
      ...
      form_text += "<tr>
                    ...
                    </tr>" if self.work_description == true   
      form_text += "<tr>
                    ...
                    </tr>" if self.date_requested == true               
      form_text += "<tr>
                    ...
                    </tr>" if self.time_requested == true         
      form_text += "              <tr>
                    ...
                    </tr>" if self.other_information == true         
      form_text += "<tr>
                    <td width=\"164\" align=\"right\"><label for=\"time\">#{self.custom1_text}</label></td>
                    <td><input id=\"custom1_value\" maxlength=\"40\" name=\"submission[custom1_value]\" size=\"20\" type=\"text\"/></td>
                    </tr>" if self.custom1_text.present?
      form_text += "<tr>
                    <td width=\"164\" align=\"right\"><label for=\"time\">#{self.custom2_text}</label></td>
                    <td><input id=\"custom1_value\" maxlength=\"40\" name=\"submission[custom2_value]\" size=\"20\" type=\"text\"/></td>
                    </tr>" if self.custom2_text.present?
      form_text += "<tr>
                    <td width=\"164\" align=\"right\"><label for=\"time\">#{self.custom3_text}</label></td>
                    <td><input id=\"custom1_value\" maxlength=\"40\" name=\"submission[custom3_value]\" size=\"20\" type=\"text\"/></td>
                    </tr>" if self.custom3_text.present?
      form_text += "<tr>
                    <td width=\"164\" align=\"right\"><label for=\"time\">#{self.custom4_text}</label></td>
                    <td><input id=\"custom1_value\" maxlength=\"40\" name=\"submission[custom4_value]\" size=\"20\" type=\"text\"/></td>
                    </tr>" if self.custom4_text.present?
      form_text += "<tr>
                    <td width=\"164\">&nbsp;</td>
