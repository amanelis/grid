class Campaign < ActiveRecord::Base
  ...
  named_scope :cityvoice, :conditions => ['LCASE(flavor) = ? OR LCASE(flavor) = ? OR LCASE(flavor) = ? OR LCASE(flavor) = ? OR LCASE(flavor) = ? OR LCASE(flavor) = ? OR LCASE(flavor) = ?', 'seo', 'sem - all', 'sem - bing', 'sem - google', 'sem - google boost', 'sem - google mobile', 'sem - yahoo']
