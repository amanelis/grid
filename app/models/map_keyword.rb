class MapKeyword < ActiveRecord::Base
  ...
  def self.update_keywords_from_salesforce
   ...
   def fetch_map_rankings
     if !self.ranking_updated_on.present? || self.ranking_updated_on < Date.today - 6.days
       ...
       if google_result.present? 
         ranking = MapRanking.create(:map_keyword_id => self.id,
   ...
   def get_google_ranking   
     ...
     if self.maps_campaign.company_name.present?
       company = self.maps_campaign.company_name 
     else
       company = self.campaign.account.name
     end
       ...
       (1..20).each do |num|
         if result["result"] == 1000
           ...
           wholepage.each do |resultitem|
             ...
             if addressstart != nil && addressstop != nil
             ...
             if companyname.index(company) != nil
               ...
               begin
                 ...
                 if citationstart != nil
                   ...
                   if citationstop == nil
                     ...
                     citations = cit_string.to_i + 5 if cit_string != nil
                   end
                 end
               rescue
               ...
               begin
                 ...
                 if contentstart != nil
                   ...
                   if contentstop == nil
                     ...
                     user_content = contentblock.to_i + 5 if contentblock != nil
                   end
                 end
               rescue
               ...
               result["page"] = page
               result["review_count"] = review.to_i if review != nil
               result["coupon_count"] = coupons.to_i if coupons != nil
               result["citation_count"] = citations.to_i if citations != nil
               result["user_content_count"] = user_content.to_i if user_content != nil
             end
           end
         end
       pagenum += 10
