  ...
  def self.update_temperatures
    ...
    zips.each do |zip|
      begin
        ...
        forecast.humidity = response["xml_api_reply"]["weather"]["current_conditions"]["humidity"]["data"].gsub("Humidity: ", "") if response["xml_api_reply"]["weather"]["forecast_information"]["humidity"].present?
