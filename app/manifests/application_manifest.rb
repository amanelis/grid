...
class ApplicationManifest < Moonshine::Manifest::Rails
  ...
  def application_packages
    ...
    on_stage 'production' do
      ...
      cron 'update_sem_campaign_reports_by_campaign', :command => "/home/deploy/grid/current/script/runner -e #{deploy_stage} GoogleSemCampaign.update_sem_campaign_reports_by_campaign", :user => configuration[:user], :minute => 1, :hour => 9
      cron 'update_sem_campaign_reports_by_ad', :command => "/home/deploy/grid/current/script/runner -e #{deploy_stage} GoogleSemCampaign.update_sem_campaign_reports_by_ad", :user => configuration[:user], :minute => 1, :hour => 11
